plugins {
    ...
    // Hilt plugin — processing @Module, @Binds, @Inject annotations in feature-workout:data /
    // Плагин Hilt — обработка аннотаций @Module, @Binds, @Inject в feature-workout:data
    alias(libs.plugins.hilt)
    alias(libs.plugins.ksp)
}

android {
    namespace = "com.vasev.trainingapp.feature.workout.data"
    compileSdk = 34
...
dependencies {
    ...
    // feature-workout:domain — repository interfaces and domain models /
    // feature-workout:domain — интерфейсы репозиториев и domain-модели
    implementation(project(":features:feature-workout:domain"))
