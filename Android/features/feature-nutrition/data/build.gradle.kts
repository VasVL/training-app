plugins {
    ...
    // Hilt plugin — processing @Module, @Binds, @Inject annotations in feature-nutrition:data /
    // Плагин Hilt — обработка аннотаций @Module, @Binds, @Inject в feature-nutrition:data
    alias(libs.plugins.hilt)
    alias(libs.plugins.ksp)
}

android {
    namespace = "com.vasev.trainingapp.feature.nutrition.data"
    compileSdk = 34
