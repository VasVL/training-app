plugins {
    ...
    // Hilt plugin — processing @Module, @Binds, @Inject annotations in feature-exercises:data /
    // Плагин Hilt — обработка аннотаций @Module, @Binds, @Inject в feature-exercises:data
    alias(libs.plugins.hilt)
    alias(libs.plugins.ksp)
}

android {
    namespace = "com.vasev.trainingapp.feature.exercises.data"
    compileSdk = 34
...
dependencies {
    ...
    // feature-exercises:domain — repository interface and domain model /
    // feature-exercises:domain — интерфейс репозитория и domain-модель
    implementation(project(":features:feature-exercises:domain"))
