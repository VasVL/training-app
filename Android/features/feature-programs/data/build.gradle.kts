plugins {
    ...
    // Hilt plugin — processing @Module, @Binds, @Inject annotations in feature-programs:data /
    // Плагин Hilt — обработка аннотаций @Module, @Binds, @Inject в feature-programs:data
    alias(libs.plugins.hilt)
    alias(libs.plugins.ksp)
}

android {
    namespace = "com.vasev.trainingapp.feature.programs.data"
    compileSdk = 34
...
dependencies {
    ...
    // feature-programs:domain — repository interfaces and domain models /
    // feature-programs:domain — интерфейсы репозиториев и domain-модели
    implementation(project(":features:feature-programs:domain"))
