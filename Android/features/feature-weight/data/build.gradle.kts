plugins {
    ...
    // Hilt plugin — processing @Module, @Binds, @Inject annotations in feature-weight:data /
    // Плагин Hilt — обработка аннотаций @Module, @Binds, @Inject в feature-weight:data
    alias(libs.plugins.hilt)
    alias(libs.plugins.ksp)
}

android {
    namespace = "com.vasev.trainingapp.feature.weight.data"
    compileSdk = 34
...
dependencies {
    ...
    // feature-weight:domain — repository interface and domain model /
    // feature-weight:domain — интерфейс репозитория и domain-модель
    implementation(project(":features:feature-weight:domain"))
