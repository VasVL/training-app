...
### `src/main/res/`
Только ресурсы уровня приложения: стили темы, название и иконка приложения, системный splash screen, разметка Activity и корневой граф навигации. Общие палитры тем находятся в `core:common:ui`, ресурсы конкретных экранов — в соответствующих feature-модулях.
