...
## Основной экран (MVP)
- Тулбар: гамбургер со стороны `START` → шторка с активным профилем и пунктами «О себе», «Пользователи», «Настройки», «Справка».
- Шапка профиля обрабатывает загрузку, готовность и ошибку; при ошибке можно повторить загрузку или выбрать профиль.
...
- «О себе» открывает активный профиль, «Пользователи» — экран выбора профиля, а настройки и справка пока открывают заглушки;
- состояния загрузки, готовности и ошибки активного профиля корректно меняют шапку шторки;
- из ошибки работают повторная загрузка и явный переход к выбору профиля;
- возврат назад работает из каждой заглушки;
- активная нижняя вкладка визуально выделяется.
